...
${nuget_cmd} install src/Voicify.Sdk.Cms/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Voicify.Sdk.Cms.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Voicify.Sdk.Cms.dll \
-recurse:'src/Voicify.Sdk.Cms/*.cs' \
-doc:bin/Voicify.Sdk.Cms.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Voicify.Sdk.Cms.dll was created successfully"
fi

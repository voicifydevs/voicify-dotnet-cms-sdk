...
namespace Voicify.Sdk.Cms.Api
{
    ...
    /// </summary>
    public interface IGoogleAuthorizationApi : IApiAccessor
    {
        ...
        ApiResponse<List<TokenResponse>> GetAvailableGoogleCredentialsAsyncWithHttpInfo (string organizationId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<bool?> GoogleAuthCallbackAsyncWithHttpInfo (string code = null, string state = null, string error = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<TokenResponse>> GetAvailableGoogleCredentialsAsyncAsync (string organizationId);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<TokenResponse>>> GetAvailableGoogleCredentialsAsyncAsyncWithHttpInfo (string organizationId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<bool?> GoogleAuthCallbackAsyncAsync (string code = null, string state = null, string error = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<bool?>> GoogleAuthCallbackAsyncAsyncWithHttpInfo (string code = null, string state = null, string error = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class GoogleAuthorizationApi : IGoogleAuthorizationApi
    {
        private Voicify.Sdk.Cms.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleAuthorizationApi"/> class.
        /// </summary>
        /// <returns></returns>
        public GoogleAuthorizationApi(String basePath)
        {
        ...
        /// <returns></returns>
        public GoogleAuthorizationApi(Voicify.Sdk.Cms.Client.Configuration configuration = null)
        {
        ...
        /// <param name="organizationId"></param>
        /// <returns>List&lt;TokenResponse&gt;</returns>
        public List<TokenResponse> GetAvailableGoogleCredentialsAsync (string organizationId)
        {
             ApiResponse<List<TokenResponse>> localVarResponse = GetAvailableGoogleCredentialsAsyncWithHttpInfo(organizationId);
        ...
        /// <param name="organizationId"></param>
        /// <returns>ApiResponse of List&lt;TokenResponse&gt;</returns>
        public ApiResponse< List<TokenResponse> > GetAvailableGoogleCredentialsAsyncWithHttpInfo (string organizationId)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
                throw new ApiException(400, "Missing required parameter 'organizationId' when calling GoogleAuthorizationApi->GetAvailableGoogleCredentialsAsync");

            var localVarPath = "/api/GoogleAuthorization/Credentials/{organizationId}";
            ...
            {
                Exception exception = ExceptionFactory("GetAvailableGoogleCredentialsAsync", localVarResponse);
        ...
        /// <param name="organizationId"></param>
        /// <returns>Task of List&lt;TokenResponse&gt;</returns>
        public async System.Threading.Tasks.Task<List<TokenResponse>> GetAvailableGoogleCredentialsAsyncAsync (string organizationId)
        {
             ApiResponse<List<TokenResponse>> localVarResponse = await GetAvailableGoogleCredentialsAsyncAsyncWithHttpInfo(organizationId);
             return localVarResponse.Data;
        ...
        /// <param name="organizationId"></param>
        /// <returns>Task of ApiResponse (List&lt;TokenResponse&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<TokenResponse>>> GetAvailableGoogleCredentialsAsyncAsyncWithHttpInfo (string organizationId)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
                throw new ApiException(400, "Missing required parameter 'organizationId' when calling GoogleAuthorizationApi->GetAvailableGoogleCredentialsAsync");
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>bool?</returns>
        public bool? GoogleAuthCallbackAsync (string code = null, string state = null, string error = null)
        {
             ApiResponse<bool?> localVarResponse = GoogleAuthCallbackAsyncWithHttpInfo(code, state, error);
             return localVarResponse.Data;
        }
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > GoogleAuthCallbackAsyncWithHttpInfo (string code = null, string state = null, string error = null)
        {

            var localVarPath = "/api/GoogleAuthorization/Callback";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GoogleAuthCallbackAsync", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> GoogleAuthCallbackAsyncAsync (string code = null, string state = null, string error = null)
        {
             ApiResponse<bool?> localVarResponse = await GoogleAuthCallbackAsyncAsyncWithHttpInfo(code, state, error);
             return localVarResponse.Data;
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> GoogleAuthCallbackAsyncAsyncWithHttpInfo (string code = null, string state = null, string error = null)
        {
        ...
        public ApiResponse< bool? > RemoveCredentialWithHttpInfo (string tokenId)
        {
            ...
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling GoogleAuthorizationApi->RemoveCredential");

            var localVarPath = "/api/GoogleAuthorization/Credentials/{tokenId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< string > RequestAuthenticationUrlWithHttpInfo (string organizationId = null, string applicationId = null, string salt = null)
        {
            ...
            var localVarPath = "/api/GoogleAuthorization/AuthorizationUrl";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();

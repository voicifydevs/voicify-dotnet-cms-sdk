...
namespace Voicify.Sdk.Cms.Api
{
    ...
    /// </summary>
    public interface IMicrosoftAuthorizationApi : IApiAccessor
    {
        ...
        ApiResponse<bool?> MicrosoftAuthCallbackAsyncWithHttpInfo (string code = null, string state = null, string error = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<bool?> MicrosoftAuthCallbackAsyncAsync (string code = null, string state = null, string error = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<bool?>> MicrosoftAuthCallbackAsyncAsyncWithHttpInfo (string code = null, string state = null, string error = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MicrosoftAuthorizationApi : IMicrosoftAuthorizationApi
    {
        private Voicify.Sdk.Cms.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MicrosoftAuthorizationApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MicrosoftAuthorizationApi(String basePath)
        {
        ...
        /// <returns></returns>
        public MicrosoftAuthorizationApi(Voicify.Sdk.Cms.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<TokenResponse> > GetAvailableCredentialsWithHttpInfo (string organizationId)
        {
            ...
            if (organizationId == null)
                throw new ApiException(400, "Missing required parameter 'organizationId' when calling MicrosoftAuthorizationApi->GetAvailableCredentials");

            var localVarPath = "/api/MicrosoftAuthorization/Credentials/{organizationId}";
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>bool?</returns>
        public bool? MicrosoftAuthCallbackAsync (string code = null, string state = null, string error = null)
        {
             ApiResponse<bool?> localVarResponse = MicrosoftAuthCallbackAsyncWithHttpInfo(code, state, error);
             return localVarResponse.Data;
        }
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > MicrosoftAuthCallbackAsyncWithHttpInfo (string code = null, string state = null, string error = null)
        {

            var localVarPath = "/api/MicrosoftAuthorization/Callback";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("MicrosoftAuthCallbackAsync", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> MicrosoftAuthCallbackAsyncAsync (string code = null, string state = null, string error = null)
        {
             ApiResponse<bool?> localVarResponse = await MicrosoftAuthCallbackAsyncAsyncWithHttpInfo(code, state, error);
             return localVarResponse.Data;
        ...
        /// <param name="error"> (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> MicrosoftAuthCallbackAsyncAsyncWithHttpInfo (string code = null, string state = null, string error = null)
        {
        ...
        public ApiResponse< bool? > RemoveCredentialWithHttpInfo (string tokenId)
        {
            ...
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling MicrosoftAuthorizationApi->RemoveCredential");

            var localVarPath = "/api/MicrosoftAuthorization/Credentials/{tokenId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< string > RequestAuthenticationUrlWithHttpInfo (string organizationId = null, string applicationId = null, string salt = null)
        {
            ...
            var localVarPath = "/api/MicrosoftAuthorization/AuthorizationUrl";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
